    ...
    for mail_id in self.ids:
        ...
        try:
            ...
            if notifs:
                ...
                notifs.flush(fnames=['notification_status', 'failure_type', 'failure_reason'],
                             records=notifs)
            ...
            for email in email_list:
                msg = IrMailServer.build_email(
                    email_from='%s <service@arrowhitech.org>' % (
                        mail.mail_message_id.author_id.name),
            ...
            if res:  # mail has been sent at least once, no major exception occured
                ...
                _logger.info('Mail with ID %r and Message-Id %r successfully sent', mail.id,
                             mail.message_id)
